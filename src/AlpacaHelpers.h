...
#define ALPACA_DRIVER_INFO "(c)2025 DreamSky Observatory"
#define ALPACA_DESCRIPTION "{\"ServerName\":\"ESP32 Ascom Alpaca Server\",\"Authors\":\"gamba69 based on Njaal Brekke & Agnuca\",\"ServerVersion\":\"v2.0\"}"
